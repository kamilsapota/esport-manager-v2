    ...
    <div className="p-6 max-w-6xl mx-auto relative">
                ...
                <div className="w-full md:w-72 bg-gray-900/80 p-6 flex flex-col justify-center border-r border-gray-800 relative">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-2xl font-bold text-white mb-1 flex items-center gap-2">
                            {team.name}
                            {/* Optional: Add team country flag here if desired, derived from team.players[0].country or team metadata if added */}
                        </h3>
      ...
      {selectedPlayer && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={() => setSelectedPlayer(null)}>
              <div className="max-w-sm w-full bg-cs-darker border border-gray-700 rounded-xl shadow-2xl relative overflow-hidden" onClick={e => e.stopPropagation()}>
